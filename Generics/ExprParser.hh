...
struct XP_TokenStream {
  ...
  //  Interface -- implement this:
    ...
    // Building expression:    
    virtual void* applyPrefix (uint op_tag, void* expr) = 0;
    virtual void* applyPostfix(uint op_tag, void* expr) = 0;
    virtual void* applyInfix  (uint op_tag, void* expr0, void* expr1) = 0;
