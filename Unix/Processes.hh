...
struct ProcMode {
    ...
    ProcMode(String username_ = "", String dir_ = "", bool own_group_ = false, double timeout_ = DBL_MAX, uint64 memout_ = UINT64_MAX,
             String stdin_file_ = "", String stdout_file_ = "", String stderr_file_ = "") :
        username(username_), dir(dir_), own_group(own_group_), timeout(timeout_), memout(memout_),
